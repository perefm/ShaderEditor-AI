...
**Tests**: Every story and every shared foundation change MUST include at least
one verification task. This can be an automated test or a documented manual
validation task when automation is not practical.
...
- [ ] T003 [P] Configure project build and run prerequisites for supported platforms
- [ ] T004 [P] Define the verification approach for this feature
...
- [ ] T009 Configure error handling for platform-specific usage paths
- [ ] T010 Setup environment configuration management
- [ ] T011 [P] Define shared UI behavior and platform/OpenGL assumptions required by the constitution
...
> **NOTE**: Prefer automated tests. If that is not practical, add a manual
> validation task with exact steps.
...
- [ ] T014 [P] [US1] Manual or automated validation for the primary supported-platform workflow
...
- [ ] T019 [US1] Add validation, UI states, and error handling
- [ ] T020 [US1] Verify the feature behaves correctly on the intended supported platforms
...
- [ ] T023 [P] [US2] Manual or automated validation for the primary supported-platform workflow
...
- [ ] T030 [P] [US3] Manual or automated validation for the primary supported-platform workflow
...
- Core implementation before final platform and rendering validation
...
Task: "Manual or automated validation for the primary supported-platform workflow"
...
- Capture UI consistency, platform validation, and rendering validation in the relevant story tasks
